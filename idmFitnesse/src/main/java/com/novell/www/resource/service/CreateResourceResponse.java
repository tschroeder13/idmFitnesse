...
public class CreateResourceResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the result value for this CreateResourceResponse.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this CreateResourceResponse.
     * 
     * @param result
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.novell.com/resource/service", "createResourceResponse"));
