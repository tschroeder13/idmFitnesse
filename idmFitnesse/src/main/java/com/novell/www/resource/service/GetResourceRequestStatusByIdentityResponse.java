/**
 * GetResourceRequestStatusByIdentityResponse.java
 *
...
public class GetResourceRequestStatusByIdentityResponse  implements java.io.Serializable {
    private com.novell.www.resource.service.ResourceAssignmentRequestStatus[] result;

    public GetResourceRequestStatusByIdentityResponse() {
    }
    ...
    /**
     * Gets the result value for this GetResourceRequestStatusByIdentityResponse.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this GetResourceRequestStatusByIdentityResponse.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetResourceRequestStatusByIdentityResponse)) return false;
        GetResourceRequestStatusByIdentityResponse other = (GetResourceRequestStatusByIdentityResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetResourceRequestStatusByIdentityResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.novell.com/resource/service", "getResourceRequestStatusByIdentityResponse"));
