/**
 * GetResourceRequestStatusByCorrelationIdResponse.java
 *
...
public class GetResourceRequestStatusByCorrelationIdResponse  implements java.io.Serializable {
    private com.novell.www.resource.service.ResourceAssignmentRequestStatus[] result;

    public GetResourceRequestStatusByCorrelationIdResponse() {
    }
    ...
    /**
     * Gets the result value for this GetResourceRequestStatusByCorrelationIdResponse.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this GetResourceRequestStatusByCorrelationIdResponse.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetResourceRequestStatusByCorrelationIdResponse)) return false;
        GetResourceRequestStatusByCorrelationIdResponse other = (GetResourceRequestStatusByCorrelationIdResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetResourceRequestStatusByCorrelationIdResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.novell.com/resource/service", "getResourceRequestStatusByCorrelationIdResponse"));
